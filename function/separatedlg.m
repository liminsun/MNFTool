    ...
    switch cmd
        case 'bn_sepload'
            if str2num(get(handles.ed_pagesize,'string')) < 1000
                warndlg('The page size should be larger than 1000.','Check the page size');
                set(handles.bn_sepload,'Value',0);
                return;
            end
            uiresume;
        case 'bn_fulload'
...
if button_state == get(handles.bn_sepload,'Max')
    ...
    PageSize = str2num(get(handles.ed_pagesize, 'string'));
    nPage = ceil(fulsamples/PageSize);
